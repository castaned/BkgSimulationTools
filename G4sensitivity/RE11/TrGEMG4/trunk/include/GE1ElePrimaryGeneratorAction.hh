...
#ifndef GE1ElePrimaryGeneratorAction_h
#define GE1ElePrimaryGeneratorAction_h 1
...
class GE1ElePrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    GE1ElePrimaryGeneratorAction(
