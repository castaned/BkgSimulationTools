...
#ifndef GE1PosPrimaryGeneratorAction_h
#define GE1PosPrimaryGeneratorAction_h 1
...
class GE1PosPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    GE1PosPrimaryGeneratorAction(
