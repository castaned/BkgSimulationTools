#ifndef RPCDetectorConstruction_hh
#define RPCDetectorConstruction_hh
...
class RPCDetectorConstruction : public G4VUserDetectorConstruction
{
   public :
      // Constructor
      RPCDetectorConstruction() ;
      // Destructor
      ~RPCDetectorConstruction() ;
